...
- **Purpose of the Project**
  - I started this project in 2021, but only now had the time and motivation to (partially) finish it. The main goal of this project is to introduce the user (and me, when I started it) to the tools of topological data analysis. 
That requires some understanding of algebraic topology, and while we will 
try to cover some of the most relevant parts here, we refer the reader to the literature folder. 
...
## 2. Theoretical Background
  ...
  - **For more details on the mathematics behind this section, we refer the reader to 
...
which express itself via different observables (times series TS_1, TS_2, etc...).
...
- **Data**
  ...
  behind the calculations will be published later on arxiv. For now, we refer the reader
...
- **Performing PCA**
  ...
  function is created. Significant functions are well commented, we also refer the reader
  to read the docs of teh PCA function of `sklearn.decomposition` for further details.
...
- **TS-PCA-TD**
  ...
  - We refer the reader to the images folder, where you will find an image with a summary of the Betti numbers for the different topological objects. 
...
- **PCA on Video - Throat**
  - The computation of this option is similar to the one below, although simpler. We refer the reader
...
- **Summary of Work**
  - Recap the main objectives and how they were achieved.
  - Emphasize the effectiveness of using PCA and TDA on video data.

- **Future Work**
  - Suggest potential extensions or improvements.
  - Mention possibilities for analyzing different datasets or applying other TDA techniques.
...
- **Literature Used**
  ...
  - Hopefully soon I am going to have time to write up a decent version of teh explanation of the code. 
...
components. The presence of higher-dimensional features (green points for  H_2 ) 
